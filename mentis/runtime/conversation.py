...
from mentis.runtime.langchain.schema import (
    is_function_or_tool_call,
    is_tool_related_message,
)
from mentis.runtime.function_calling import FunctionCallSupport
from mentis.runtime.models import ModelRegistry, ChatModel
from mentis.logging import logger
...
"""
    ...
    @staticmethod
    def __get_qwen_token_num_from_message(
        model_name: str, messages: BaseMessage
    ) -> int:
