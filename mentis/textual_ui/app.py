...
from mentis.logging import setup_logging, log_path
from mentis.config import AppConfig
from mentis.runtime.function_calling.function_call_support import (
    load_function_entry_points,
)
from mentis.runtime.models import AppContext
from mentis.runtime.conv_manager import ConversationManager
from mentis.runtime.conversation import conversation_path, export_path

from mentis.textual_ui.screens import ChatScreenDark, ChatScreenLight
from mentis.textual_ui.widgets.footer import CommandFooter, Command, Field


class MentisTextual(App):
    def __init__(self, context: Optional[AppContext] = None) -> None:
        ...
        self.file_paths = [str(log_path / "mentis.jsonl")]
        self.merge = True
