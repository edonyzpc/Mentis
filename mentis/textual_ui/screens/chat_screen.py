...
from mentis.runtime.conv_manager import ConversationManager
from mentis.textual_ui.screens.search_screen import SearchScreen
from mentis.textual_ui.widgets.chatbox import Chatbox
from mentis.textual_ui.widgets.footer import CommandFooter
from mentis.textual_ui.widgets.chat import Chat
from mentis.textual_ui.widgets.header import ChatHeader
from mentis.textual_ui.widgets.chat_list import ChatList
from mentis.textual_ui.widgets.model_select import ModelSelect
from mentis.textual_ui.screens.log_screen import LogScreen
from mentis.textual_ui.widgets.search import Search
...
class ChatScreen(Screen):
    BINDINGS = [
        ...
        Binding("ctrl+l", action="open_log", description="Show Log", key_display="^l"),
    ]
